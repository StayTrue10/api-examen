<div class="card border-0 shadow rounded-3 my-5">
    <div class="card-body p-4 p-sm-5">
        <h5 class="card-title text-center mb-5 fw-light h3">Hacer una reservación</h5>
        <form>
            ...
            <div class="form-floating mb-3">
                <input wire:model="numero" maxlength="12" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" type="text" class="form-control" id="telefono" placeholder="Teléfono">
            ...
            <div class="d-grid">
                <button class="btn btn-primary btn-login text-uppercase fw-bold" type="submit">Reservar</button>
            </div>
        </form>
    </div>
</div>